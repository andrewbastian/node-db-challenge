...
a relational database (RDBMS) is database software. SQL is the language the datbase is written in.

- [ ] Why do tables need a `primary key`?

as a refference point for the rows in the table
